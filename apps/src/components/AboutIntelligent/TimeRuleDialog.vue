...
watch(() => props.data, (newVal) => {
  if (newVal) {
    Object.assign(form, {
      weekdays: newVal.weekdays || [1, 2, 3, 4, 5],
      startWeek: newVal.startWeek || 1,
      endWeek: newVal.endWeek || 20,
      weekType: newVal.weekType || "Both",
      startTime: newVal.startTime || "08:00:00",
      endTime: newVal.endTime || "18:00:00",
      semesterId: newVal.semesterId || termList.value[0]?.id || null,
    });
  } else {
    resetForm();
  }
