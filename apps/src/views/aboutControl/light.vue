  ...
  <div class="light-env-page">
    <div class="main-content">
      ...
      <div class="filter-row first-row">
        ...
        <div class="stat">
          <span>{{ tableData.length }}个照明，{{ openCount }}个开启</span>
        </div>
      </div>
 ...
 <div class="button-group right-buttons">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="deviceName" label="电灯空开" align="center" />
          <el-table-column prop="isOpen" label="开关状态" align="center">
            <template #default="{ row }">
              <el-tag
...
import RemoteControl from "@/components/AboutLight/RemoteControl.vue";
