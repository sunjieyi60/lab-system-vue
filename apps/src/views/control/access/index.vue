      ...
      <div class="filter-row second-row">
        ...
        <div class="button-group right-buttons">
          ...
          <span class="device-stat">
            {{ onlineDeviceCount }}扇房门在线，总共{{ totalDeviceCount }}扇
          </span>
        </div>
      </div>
...
import AddNode from "@/views/control/access/components/AddNodeHvac.vue";
import RemoteControl from "@/views/control/access/components/RemoteControl.vue";
import DelaySetting from "@/views/control/access/components/DelaySetting.vue";
import IntelligentControl from "@/views/control/access/components/IntelligentControl.vue";
...
const tableData = computed(() => {
  ...
  if (building.value && building.value !== "all") {
    ...
    const labsInBuilding = laboratoryList.value.filter(
